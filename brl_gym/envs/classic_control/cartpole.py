...
class CartPoleEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.param_space = dict(
            # masspole=spaces.Box(np.array([0.075]), np.array([0.125]), dtype=np.float32),
            length=spaces.Box(np.array([0.5-0.125]),np.array([0.5+0.125]), dtype=np.float32))
            # length=spaces.Box(np.array([0.5]),np.array([0.5]), dtype=np.float32))
